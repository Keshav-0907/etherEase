        ...
        <div className="border-[1px] border-[#2f2f2f] h-full flex py-5">
          ...
          <div className="w-8/12">
            <div className="px-3 pt-10 flex flex-col gap-3">
              ...
              <div>
              Create unique music NFTs effortlessly with user-friendly platforms like Mintable or Rarible. Simply upload your tracks, set parameters like royalties and editions, and mint your NFTs. Connect with fans directly, retain rights, and monetize your art in the booming world of blockchain without needing any coding skills.
              </div>
            </div>
