...
export default function Signup() {
  ...
  const createAccountAddress = async (
    ...
    const wallet = new ethers.Wallet("07c7873ca5538130d7fdf6c9223831bac41f583d99e5ef0eacedb08ee539de4d", provider);
    // Transfer Ether
    (async () => {
          ...
          
          {
            smartWalletAddress ? (<div>
              ...
              <div>
                ...
                >
                  <span>{loading ? ('Generating Smart Wallet Address....') : ('Generate Smart Address')} </span>
                </button>
              </div>
            )
          }
